...
micromonas_only <- micromonas_only %>% filter (Species %in% c( "Micromonas_Clade-A.ABC.1-2(100)", "Micromonas_Clade-A.ABC.1-2(81)", "Micromonas_Clade-A.ABC.1-2(82)", "Micromonas_Clade-A.ABC.1-2(84)", "Micromonas_Clade-A.ABC.1-2(85)", "Micromonas_Clade-A.ABC.1-2(86)", "Micromonas_Clade-A.ABC.1-2(87)", "Micromonas_Clade-A.ABC.1-2(88)", "Micromonas_Clade-A.ABC.1-2(89)", "Micromonas_Clade-A.ABC.1-2(90)", "Micromonas_Clade-A.ABC.1-2(91)", "Micromonas_Clade-A.ABC.1-2(93)", "Micromonas_Clade-A.ABC.1-2(94)", "Micromonas_Clade-A.ABC.1-2(96)", "Micromonas_Clade-A.ABC.1-2(97)", "Micromonas_Clade-A.ABC.1-2(98)", "Micromonas_Clade-A.ABC.1-2(99)")) %>% 
  add_count(V4_ID, wt = copies, name = "total_a1_sample") 

micromonas_only2 <- micromonas_only[!duplicated(micromonas_only), ]

micromonas_only2 = select(micromonas_only2, -Species) 

micromonas_only2$percent_a1_micromonas <- (micromonas_only2$total_a1_sample/micromonas_only2$total_micromonas_sample)
...
v1v2_micromonas_only <- v1v2_micromonas_only %>% filter (name %in% c("seq345", "seq1217", "seq61", "seq273", "seq816")) %>%  add_count(Sample, wt = copies, name = "total_a_sample") 

v1v2_micromonas_only$percent_a_micromonas <- (v1v2_micromonas_only$total_a_sample/v1v2_micromonas_only$total_micromonas_sample_v1v2)
...
v1v2_v4_micromonas_metadata = select(v1v2_v4_micromonas_metadata, `gsub("BS227_S65", "BS_227_S65", Sample)`, total_micromonas_sample_v1v2, total_a_sample, percent_a_micromonas, V4_18s_ID, V4_ID, total_micromonas_sample, total_a1_sample, percent_a1_micromonas) 
...
#choose just samples with seq2535 and/or pusilla

v1v2_v4_micromonas_metadata_subset <- v1v2_v4_micromonas_metadata[v1v2_v4_micromonas_metadata$total_a_sample != 0 | v1v2_v4_micromonas_metadata$total_a1_sample !=0,]


shapiro.test(v1v2_v4_micromonas_metadata_subset$percent_a_micromonas)

hist(v1v2_v4_micromonas_metadata_subset$percent_a_micromonas)

shapiro.test(v1v2_v4_micromonas_metadata_subset$percent_a1_micromonas)

hist(v1v2_v4_micromonas_metadata_subset$percent_a1_micromonas)

cor.test(v1v2_v4_micromonas_metadata_subset$percent_a_micromonas, v1v2_v4_micromonas_metadata_subset$percent_a1_micromonas, method="spearman", exact = FALSE)
...
cor.test(v1v2_v4_micromonas_metadata_subset.ten$percent_a_micromonas, v1v2_v4_micromonas_metadata_subset.ten$percent_a1_micromonas, method="spearman", exact = FALSE)

#linear regression

model <- lm(v1v2_v4_micromonas_metadata_subset$percent_a_micromonas ~ v1v2_v4_micromonas_metadata_subset$percent_a1_micromonas, data = v1v2_v4_micromonas_metadata_subset)

bptest(model)

lm_all = lm(percent_a_micromonas~percent_a1_micromonas, data = v1v2_v4_micromonas_metadata_subset)

summary(lm_all)

lm_10 = lm(percent_a_micromonas~percent_a1_micromonas, data = v1v2_v4_micromonas_metadata_subset.ten)
...
ggplot(v1v2_v4_micromonas_metadata_subset, aes(percent_a1_micromonas, percent_a_micromonas)) +geom_point(size=2, shape=23) + xlim(0,1) + ylim(0,1) + theme_classic()

all_graph_lm <- v1v2_v4_micromonas_metadata_subset %>%
  ggplot(aes(x=percent_a1_micromonas,y=percent_a_micromonas)) +
  geom_point(alpha=1) +
  geom_smooth(method=lm, se=FALSE) + theme_classic() + xlim(0,1) + ylim(0,1)

all_graph_lm

ggsave("lm_graph_a1_all.pdf", plot=all_graph_lm, height=8, width=16, units="cm", dpi=300)

ggplot(v1v2_v4_micromonas_metadata_subset.ten, aes(percent_a1_micromonas, percent_a_micromonas)) +geom_point(size=2, shape=23) + xlim(0,1) + ylim(0,1) + theme_classic()
...
ggsave("lm_graph_a1_10.pdf", plot=ten_graph_lm, height=8, width=16, units="cm", dpi=300)
```
