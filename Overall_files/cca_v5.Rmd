...
```{r cars}
df_all_count <-  read_tsv("/Users/ceckmann/Desktop/bats_2016_2019/processed_data/cca/newest_cca/all_asvs_summary_metadata.tsv")

rownames(df_all_count) <- df_all_count$Sample

df_all_count <- df_all_count[rowSums(df_all_count[c(9:ncol(df_all_count))]) > 0,]

my.ASVtable <- df_all_count[c(9:ncol(df_all_count))]

my.metadata <- df_all_count[c(2:7)]

my.metadata_no_season <- df_all_count[c(3:7)]
...
my.metadata_no_season_subset <- my.metadata_subset[c(2:6)]
...
ggsave(
  ...
  filename = "vegan_pCCA_hellinger_transformation_color_version_reclassified_v3.pdf", # my.finalmodel selected (i.e., CCA)
  plot = last_plot(),
  device = "pdf",
  path = NULL,
  scale = 1,
...
ggsave(
  filename = "vegan_pCCA_hellinger_transformation_color_version_reclassified_labeled_v2.pdf", # my.finalmodel selected (i.e., CCA)
...
ggsave(
  filename = "vegan_pCCA_hellinger_transformation_color_version_reclassified_unlabeled_v2.pdf", # my.finalmodel selected (i.e., CCA)
